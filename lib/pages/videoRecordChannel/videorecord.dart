...
import 'package:dttube/pages/videoRecordChannel/galleryvideo.dart';
import 'package:dttube/pages/videoRecordChannel/videopreview.dart';
import 'package:dttube/pages/videorecord/galleryvideo.dart';
...
class VideoRecordChannel extends StatefulWidget {
  final String? contestId, contestImg, hashtagName, hashtagId;

  const VideoRecordChannel(
      {Key? key,
  ...
  @override
  State<VideoRecordChannel> createState() => _VideoRecordChannelState();
}

class _VideoRecordChannelState extends State<VideoRecordChannel> {
