import 'dart:io';
import 'package:dttube/main.dart';
import 'package:dttube/pages/videoRecordChannel/videopreview.dart';
import 'package:dttube/pages/videorecord/videopreview.dart';
...
class GalleryVideoChannel extends StatefulWidget {
  final String vFilePath, vDuration, contestId, hashtagName, hashtagId;

  const GalleryVideoChannel(
      {Key? key,
  ...
  @override
  State<GalleryVideoChannel> createState() => _GalleryVideoChannelState();
}

class _GalleryVideoChannelState extends State<GalleryVideoChannel> with RouteAware {
