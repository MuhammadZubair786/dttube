...
import 'package:dttube/pages/videoRecordChannel/postvideo.dart';
...
class VideoPreviewChannel extends StatefulWidget {
  final String filePath, vDuration, soundId, contestId, hashtagName, hashtagId;

  const VideoPreviewChannel(
      {Key? key,
  ...
  @override
  State<VideoPreviewChannel> createState() => _VideoPreviewChannelState();
}

class _VideoPreviewChannelState extends State<VideoPreviewChannel> with RouteAware {
    ...
    return VisibilityDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: MyText(
              color: white,
              text: "Youth Channel Video Preview",
                ...
                child: InkWell(
                  onTap: () async {
                    await Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PostVideoChannel(
                          videoFile: File(widget.filePath),
                          contestId: widget.contestId,
                          vDuration: widget.vDuration,
                          soundId: widget.soundId,
